...
- [ ] Historical data trending & predictions
...
MIT License - Feel free to use this for hackathons or learning!
...
1. **`backend/services/riskScoringService.js`** - Core risk calculation logic
2. **`backend/services/outreachService.js`** - Action recommendations & AI integration
3. **`frontend/app.js`** - Frontend API calls and UI logic
...
- **Demo Focus:** Show the end-to-end flow (view → analyze → generate → feedback)
- **Highlight:** The AI message generation and personalization
- **Metrics:** Point out the high-risk customer count and top churn reasons
- **User Experience:** Show how the color-coded dashboard makes risk obvious
- **Future Potential:** Discuss ML/AI enhancements
